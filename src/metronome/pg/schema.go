...
func tasksSQL() (*asset, error) {
	...
	info := bindataFileInfo{name: "tasks.sql", size: 436, mode: os.FileMode(420), modTime: time.Unix(1481625152, 0)}
...
func usersSQL() (*asset, error) {
	...
	info := bindataFileInfo{name: "users.sql", size: 425, mode: os.FileMode(420), modTime: time.Unix(1481624955, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
