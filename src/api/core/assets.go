...
func authSchemaAccesstokenqueryJSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "auth/schema/accessTokenQuery.json", size: 246, mode: os.FileMode(416), modTime: time.Unix(1481554585, 0)}
...
func taskSchemaCreateJSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "task/schema/create.json", size: 347, mode: os.FileMode(416), modTime: time.Unix(1481507406, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"auth": {nil, map[string]*bintree{
		"schema": {nil, map[string]*bintree{
			"accessTokenQuery.json": {authSchemaAccesstokenqueryJSON, map[string]*bintree{}},
